...
"spicy":{ar:"سبايسي",en:"Spicy",icon:"🌶️",allergens:["soy"],cal:85},
"sauce-a":{ar:"صوص A",en:"Sauce A",icon:"🫙",allergens:["fish","eggs","nuts"],cal:120},
"sauce-b":{ar:"صوص B",en:"Sauce B",icon:"🫙",allergens:["fish","soy"],cal:95},
"sauce-c":{ar:"صوص C",en:"Sauce C",icon:"🫙",allergens:["dairy"],cal:110},
"sauce-d":{ar:"صوص D",en:"Sauce D",icon:"🫙",allergens:["eggs"],cal:90},
"thousand-island":{ar:"ثاوزند آيلاند",en:"Thousand Island",icon:"🫙",allergens:["eggs"],cal:100},
"pomegranate-molasses":{ar:"دبس رمان",en:"Pomegranate Molasses",icon:"🫙",allergens:[],cal:45},
"ranch":{ar:"رانش",en:"Ranch",icon:"🫙",allergens:["dairy","eggs"],cal:130},
"diet-ranch":{ar:"رانش دايت",en:"Diet Ranch",icon:"🫙",allergens:["dairy"],cal:60}
},byb:{
enabled:true,
proteins:[
...
{id:"shrimp-crunch",category:"poke",cookType:"fry",image:"/images/shrimp-crunch.jpg",name:{ar:"شريمب كرانش",en:"Shrimp Crunch"},description:{ar:"رز سوشي مع روبيان مقلي مقرمش، ملفوف الصويا، ذرة محمصة، مانجو، رمان، خيار، كراب ستيك وجواكامولي بصوص سبايسي",en:"Sushi rice topped with crispy fried shrimp, soy cabbage, roasted corn, mango, pomegranate, cucumber, crab stick and guacamole in our spicy sauce"},price:38,priceLabel:null,allergens:["seafood","soy","gluten"],ingredients:{ar:["رز سوشي","روبيان مقلي","ملفوف الصويا","رمان","ذرة محمصة","خيار","مانجو","جواكامولي","كراب ستيك"],en:["Sushi Rice","Fried Shrimp","Soy Cabbage","Pomegranate","Roasted Corn","Cucumber","Mango","Guacamole","Crab Stick"]},macros:{cal:580,protein:28,carbs:65,fat:22},available:true,hiddenUntil:null,order:2,sauce:"spicy-b"},
{id:"shrimp-escape",category:"poke",cookType:"grill",image:"/images/shrimp-escape.jpg",name:{ar:"شريمب إسكيب",en:"Shrimp Escape"},description:{ar:"رز سوشي مع روبيان مشوي، أناناس مشوي، بروكلي، كراب ستيك، خيار، خس وجواكامولي بصوص كريمي",en:"Sushi rice with grilled shrimp, grilled pineapple, broccoli, crab stick, cucumber, lettuce and guacamole in our creamy sauce"},price:42,priceLabel:null,allergens:["seafood","soy"],ingredients:{ar:["رز سوشي","روبيان مشوي","أناناس مشوي","بروكلي","كراب ستيك","خيار","خس","جواكامولي"],en:["Sushi Rice","Grilled Shrimp","Grilled Pineapple","Broccoli","Crab Stick","Cucumber","Lettuce","Guacamole"]},macros:{cal:490,protein:34,carbs:55,fat:14},available:true,hiddenUntil:null,order:3,sauce:"spicy-c"},
{id:"cheat-treat",category:"poke",cookType:"fry",image:"/images/cheat-treat.jpg",name:{ar:"تشيت تريت",en:"Cheat Treat"},description:{ar:"رز سوشي مع دجاج مقلي مقرمش، طماطم شيري، ملفوف، جواكامولي، جزر، خس، رمان وذرة محمصة بصوص سبايسي",en:"Sushi rice with crispy fried chicken, cherry tomatoes, cabbage, guacamole, carrot, lettuce, pomegranate and roasted corn in our spicy sauce"},price:32,priceLabel:null,allergens:["gluten","soy"],ingredients:{ar:["رز سوشي","دجاج مقلي","طماطم شيري","ملفوف","جواكامولي","جزر","خس","رمان","ذرة محمصة"],en:["Sushi Rice","Fried Chicken","Cherry Tomatoes","Cabbage","Guacamole","Carrot","Lettuce","Pomegranate","Roasted Corn"]},macros:{cal:540,protein:30,carbs:62,fat:19},available:true,hiddenUntil:null,order:4,sauce:"spicy-b"},
{id:"grilled-gain",category:"poke",cookType:"grill",image:"/images/grilled-gain.jpg",name:{ar:"قين المشوي",en:"Grilled Gain"},description:{ar:"رز سوشي مع دجاج مشوي، خس، ملفوف الصويا، ذرة محمصة، جزر، رمان، خيار وجواكامولي بصوص خاص",en:"Sushi rice with grilled chicken, lettuce, soy cabbage, roasted corn, carrot, pomegranate, cucumber and guacamole in our special sauce"},price:34,priceLabel:null,allergens:["soy"],ingredients:{ar:["رز سوشي","دجاج مشوي","خس","ملفوف الصويا","ذرة محمصة","جزر","رمان","خيار","جواكامولي"],en:["Sushi Rice","Grilled Chicken","Lettuce","Soy Cabbage","Roasted Corn","Carrot","Pomegranate","Cucumber","Guacamole"]},macros:{cal:470,protein:36,carbs:52,fat:14},available:true,hiddenUntil:null,order:5,sauce:"spicy-dc"},
...
{id:"beef-bowl",category:"poke",cookType:"grill",image:"/images/beef-bowl.jpg",name:{ar:"بيف بوكي بول",en:"Beef Poke Bowl"},description:{ar:"رز سوشي مع شرائح لحم طرية، طماطم شيري، ملفوف، إدامامي، خس، قرنبيط وجواكامولي بصوص خاص",en:"Sushi rice with tender beef strips, cherry tomatoes, cabbage, edamame, lettuce, cauliflower and guacamole in our special sauce"},price:38,priceLabel:null,allergens:["soy"],ingredients:{ar:["رز سوشي","شرائح لحم","طماطم شيري","ملفوف","إدامامي","خس","قرنبيط","جواكامولي"],en:["Sushi Rice","Beef Strips","Cherry Tomatoes","Cabbage","Edamame","Lettuce","Cauliflower","Guacamole"]},macros:{cal:520,protein:40,carbs:50,fat:18},available:true,hiddenUntil:null,order:7,sauce:"spicy-ab"},
