...
{id:"mushroom-chicken",category:"protein",cookType:"grill",image:"/images/mushroom-chicken.jpg",name:{ar:"دجاج الفطر",en:"Mushroom Chicken"},description:{ar:"دجاج بصوص مشروم كريمي على الأرز الأبيض بطعم ناعم ومريح",en:"Chicken in creamy mushroom sauce over white rice for a smooth, comforting flavor"},price:22,priceLabel:{ar:"يبدأ من",en:"From"},allergens:["dairy","mushroom"],ingredients:{ar:["دجاج مشوي","فطر طازج","كريمة طهي","زيت زيتون","ثوم","توابل مشكلة"],en:["Grilled Chicken","Fresh Mushroom","Cooking Cream","Olive Oil","Garlic","Mixed Spices"]},macros:{cal:430,protein:37,carbs:30,fat:18},available:true,hiddenUntil:null,order:4},
