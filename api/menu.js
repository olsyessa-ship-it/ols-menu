...
const DEF={categories:[{id:"poke",ar:"بوكي بول",en:"Poke Bowls",order:1},{id:"protein",ar:"بروتين بولز",en:"Protein Bowls",order:2},{id:"tortilla",ar:"تورتيلا",en:"Tortilla",order:3},{id:"salad",ar:"سلطات وأكثر",en:"Salads & More",order:4}],allergens:{gluten:{icon:"🌾",ar:"جلوتين",en:"Gluten"},dairy:{icon:"🥛",ar:"ألبان",en:"Dairy"},seafood:{icon:"🦐",ar:"مأكولات بحرية",en:"Seafood"},soy:{icon:"🫘",ar:"صويا",en:"Soy"},eggs:{icon:"🥚",ar:"بيض",en:"Eggs"},nuts:{icon:"🥜",ar:"مكسرات",en:"Nuts"},mushroom:{icon:"🍄",ar:"فطر",en:"Mushroom"},fish:{icon:"🐟",ar:"سمك",en:"Fish"}},sauces:{
"spicy":{ar:"سبايسي",en:"Spicy",icon:"🌶️",allergens:["soy"]},
"sauce-a":{ar:"صوص A",en:"Sauce A",icon:"🫙",allergens:["fish","eggs","nuts"]},
"sauce-b":{ar:"صوص B",en:"Sauce B",icon:"🫙",allergens:["fish","soy"]},
"sauce-c":{ar:"صوص C",en:"Sauce C",icon:"🫙",allergens:["dairy"]},
"sauce-d":{ar:"صوص D",en:"Sauce D",icon:"🫙",allergens:["eggs"]},
"thousand-island":{ar:"ثاوزند آيلاند",en:"Thousand Island",icon:"🫙",allergens:["eggs"]},
"pomegranate-molasses":{ar:"دبس رمان",en:"Pomegranate Molasses",icon:"🫙",allergens:[]},
"ranch":{ar:"رانش",en:"Ranch",icon:"🫙",allergens:["dairy","eggs"]},
"diet-ranch":{ar:"رانش دايت",en:"Diet Ranch",icon:"🫙",allergens:["dairy"]}
},byb:{
enabled:true,
proteins:[
...
{id:"shrimp-crunch",category:"poke",cookType:"fry",image:"/images/shrimp-crunch.jpg",name:{ar:"شريمب كرانش",en:"Shrimp Crunch"},description:{ar:"رز سوشي مع روبيان مقلي مقرمش، ملفوف الصويا، رمان، ذرة محمصة، خيار، مانجو، جواكامولي وكراب بصوص أولس الخاص",en:"Sushi rice with crispy fried shrimp, soy cabbage, pomegranate, roasted corn, cucumber, mango, guacamole and crab in our signature OLS sauce"},price:38,priceLabel:null,allergens:["seafood","soy","gluten"],ingredients:{ar:["رز سوشي","روبيان مقلي","ملفوف الصويا","رمان","ذرة محمصة","خيار","مانجو","جواكامولي","كراب","صوص أولس"],en:["Sushi Rice","Fried Shrimp","Soy Cabbage","Pomegranate","Roasted Corn","Cucumber","Mango","Guacamole","Crab Stick","OLS Sauce"]},macros:{cal:580,protein:28,carbs:65,fat:22},available:true,hiddenUntil:null,order:2,sauce:"spicy-b"},
{id:"shrimp-escape",category:"poke",cookType:"grill",image:"/images/shrimp-escape.jpg",name:{ar:"شريمب إسكيب",en:"Shrimp Escape"},description:{ar:"رز سوشي مع روبيان مشوي، أناناس مشوي، بروكلي، كراب، خيار، خس وجواكامولي بصوص أولس الخاص",en:"Sushi rice with grilled shrimp, grilled pineapple, broccoli, crab, cucumber, lettuce and guacamole in our signature OLS sauce"},price:42,priceLabel:null,allergens:["seafood","soy"],ingredients:{ar:["رز سوشي","روبيان مشوي","أناناس مشوي","بروكلي","كراب","خيار","خس","جواكامولي","صوص أولس"],en:["Sushi Rice","Grilled Shrimp","Grilled Pineapple","Broccoli","Crab Stick","Cucumber","Lettuce","Guacamole","OLS Sauce"]},macros:{cal:490,protein:34,carbs:55,fat:14},available:true,hiddenUntil:null,order:3,sauce:"spicy-c"},
{id:"cheat-treat",category:"poke",cookType:"fry",image:"/images/cheat-treat.jpg",name:{ar:"تشيت تريت",en:"Cheat Treat"},description:{ar:"رز سوشي مع دجاج مقلي مقرمش، طماطم شيري، ملفوف، جواكامولي، جزر، خس، رمان وذرة محمصة بصوص أولس الخاص",en:"Sushi rice with crispy fried chicken, cherry tomatoes, cabbage, guacamole, carrot, lettuce, pomegranate and roasted corn in our signature OLS sauce"},price:32,priceLabel:null,allergens:["gluten","soy"],ingredients:{ar:["رز سوشي","دجاج مقلي","طماطم شيري","ملفوف","جواكامولي","جزر","خس","رمان","ذرة محمصة","صوص أولس"],en:["Sushi Rice","Fried Chicken","Cherry Tomatoes","Cabbage","Guacamole","Carrot","Lettuce","Pomegranate","Roasted Corn","OLS Sauce"]},macros:{cal:540,protein:30,carbs:62,fat:19},available:true,hiddenUntil:null,order:4,sauce:"spicy-b"},
{id:"grilled-gain",category:"poke",cookType:"grill",image:"/images/grilled-gain.jpg",name:{ar:"قين المشوي",en:"Grilled Gain"},description:{ar:"رز سوشي مع دجاج مشوي، خس، ملفوف الصويا، ذرة محمصة، جزر، رمان، خيار وجواكامولي بصوص أولس الخاص",en:"Sushi rice with grilled chicken, lettuce, soy cabbage, roasted corn, carrot, pomegranate, cucumber and guacamole in our signature OLS sauce"},price:34,priceLabel:null,allergens:["soy"],ingredients:{ar:["رز سوشي","دجاج مشوي","خس","ملفوف الصويا","ذرة محمصة","جزر","رمان","خيار","جواكامولي","صوص أولس"],en:["Sushi Rice","Grilled Chicken","Lettuce","Soy Cabbage","Roasted Corn","Carrot","Pomegranate","Cucumber","Guacamole","OLS Sauce"]},macros:{cal:470,protein:36,carbs:52,fat:14},available:true,hiddenUntil:null,order:5,sauce:"spicy-dc"},
...
{id:"beef-bowl",category:"poke",cookType:"grill",image:"/images/beef-bowl.jpg",name:{ar:"بيف بوكي بول",en:"Beef Poke Bowl"},description:{ar:"رز سوشي مع شرائح لحم طرية، ملفوف الصويا، إدامامي، طماطم، خس، بروكلي، قرنبيط وجواكامولي بصوص أولس الخاص",en:"Sushi rice with tender beef strips, soy cabbage, edamame, tomato, lettuce, broccoli, cauliflower and guacamole in our signature OLS sauce"},price:38,priceLabel:null,allergens:["soy"],ingredients:{ar:["رز سوشي","شرائح لحم","ملفوف الصويا","إدامامي","طماطم","خس","بروكلي","قرنبيط","جواكامولي","صوص أولس"],en:["Sushi Rice","Beef Strips","Soy Cabbage","Edamame","Tomato","Lettuce","Broccoli","Cauliflower","Guacamole","OLS Sauce"]},macros:{cal:520,protein:40,carbs:50,fat:18},available:true,hiddenUntil:null,order:7,sauce:"spicy-ab"},
...
{id:"crab-salad",category:"salad",cookType:"fry",image:"/images/crab-salad.jpg",name:{ar:"سلطة كرانش كراب",en:"Crab Crunch Salad"},description:{ar:"كراب طازج مع خس مقرمش، ملفوف، شمندر، جزر، خبز مقرمش، سيراتشا ومايونيز ياباني",en:"Fresh crab with crisp lettuce, cabbage, beetroot, carrot, crispy bread, sriracha and Japanese mayo"},price:32,priceLabel:null,allergens:["seafood","eggs"],ingredients:{ar:["كراب","خس","ملفوف","شمندر","جزر","خبز مقرمش","سيراتشا","مايونيز ياباني"],en:["Crab","Lettuce","Cabbage","Beetroot","Carrot","Crispy Bread","Sriracha","Japanese Mayo"]},macros:{cal:320,protein:22,carbs:18,fat:18},available:true,hiddenUntil:null,order:2}
]};
